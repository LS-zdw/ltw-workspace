...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-证书管理-个人端" desc="module=edu/trainee · pageId=ep-24 · path=/edu/trainee/ep-24"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/证书管理-个人端.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：证书管理-个人端</div>
