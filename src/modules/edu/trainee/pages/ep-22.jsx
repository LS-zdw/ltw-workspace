...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-员工参与培训-个人端" desc="module=edu/trainee · pageId=ep-22 · path=/edu/trainee/ep-22"
        right={<span className="badge">Generated</span>}
      >
        <div className="pill">
          <div className="k">角色视角</div>
          <div className="v">被培训员</div>
        </div>
        {projectName ? (
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/员工参与培训-个人端.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：员工参与培训-个人端</div>
        <div className="v">（示例值）</div>
      </div>
      <div className="pill">
        <div className="k">模块归属：edu/trainee</div>
        <div className="v">（示例值）</div>
      </div>
      <div className="pill">
