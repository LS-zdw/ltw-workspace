...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-教育培训原型设计卡" desc="module=edu/trainer · pageId=ep-05 · path=/edu/trainer/ep-05"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/教育培训原型设计卡.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：教育培训原型设计卡</div>
