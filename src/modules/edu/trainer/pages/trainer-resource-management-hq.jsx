...
const trainerRows = [
  { id: 1, enterprise: "镇海炼化", name: "梁海江", org: "安全环保部", level: "中级", phone: "15001213760", intro: "长期从事安全培训工作", skill: "环境保护、风险辨识", hours: "86", cert: "焊工证、注安师证...", score: "98%" },
  { id: 2, enterprise: "茂名石化", name: "方月蒙", org: "教育培训中心", level: "中级", phone: "15537290777", intro: "具备丰富授课经验", skill: "电器安全、设备完整性", hours: "74", cert: "安全管理资格证", score: "97%" },
  { id: 3, enterprise: "洛阳石化", name: "张亮", org: "安环部", level: "高级", phone: "13681525946", intro: "长期从事现场培训", skill: "高处作业、工艺安全", hours: "103", cert: "高处作业证...", score: "99%" },
  { id: 4, enterprise: "九江石化", name: "尤红玉", org: "设备管理部", level: "高级", phone: "18010180072", intro: "擅长实操授课", skill: "设备完整性、应急管理", hours: "92", cert: "特种作业操作证...", score: "96%" },
  { id: 5, enterprise: "广州石化", name: "卢伟", org: "安环部", level: "中级", phone: "13811220011", intro: "炼化培训讲师", skill: "工艺报警管理", hours: "65", cert: "安全管理证", score: "95%" },
  { id: 6, enterprise: "福建联合", name: "杨青", org: "生产技术部", level: "初级", phone: "13911330022", intro: "班组培训骨干", skill: "作业许可", hours: "58", cert: "焊接作业证", score: "93%" },
  { id: 7, enterprise: "仪征化纤", name: "李卓", org: "教育培训中心", level: "中级", phone: "13711440033", intro: "课程开发", skill: "JSA分析", hours: "72", cert: "注册安全工程师", score: "94%" },
  { id: 8, enterprise: "天津石化", name: "谢峰", org: "安环部", level: "高级", phone: "13611550044", intro: "危化专业", skill: "危化品管理", hours: "110", cert: "特种作业证", score: "98%" },
  { id: 9, enterprise: "海南炼化", name: "周凯", org: "生产运行部", level: "中级", phone: "13511660055", intro: "现场实操", skill: "动火作业", hours: "84", cert: "监护人证", score: "96%" },
  { id: 10, enterprise: "扬子石化", name: "陈涛", org: "安环部", level: "初级", phone: "13411770066", intro: "新任讲师", skill: "班组活动", hours: "40", cert: "培训讲师证", score: "92%" }
];
            ...
            <div className="cert-form-grid">
              <div className="cert-field-item">
                ...
                <div className="cert-field-value">
                  <select className="cert-field-control" defaultValue={mode === "add" ? "请选择" : defaultForm.enterprise} disabled={readOnly}>
                    <option>请选择</option>
                    <option>镇海炼化</option>
                    <option>茂名石化</option>
                    <option>洛阳石化</option>
      ...
      <div className="filterbar">
        <div className="filterbar-row">
          <div className="filterbar-left">
            <div className="filterbar-item"><div className="filterbar-label">所属企业：</div><div className="filterbar-input"><select className="filterbar-control" defaultValue="请选择"><option>请选择</option><option>镇海炼化</option><option>茂名石化</option><option>洛阳石化</option><option>九江石化</option><option>广州石化</option><option>福建联合</option><option>仪征化纤</option><option>天津石化</option><option>海南炼化</option><option>扬子石化</option></select></div></div>
        ...
        <table className="proto-table">
          <thead>
            <tr>
              ...
              <th>序号</th><th>所属企业</th><th>姓名</th><th>单位</th><th>师资等级</th><th>联系方式</th><th>人员简介</th><th>擅长领域</th><th>历史授课课时</th><th>证书</th><th>近一年学员满意度</th><th>操作</th>
            </tr>
          </thead>
          <tbody>
            {trainerRows.map((row) => (
