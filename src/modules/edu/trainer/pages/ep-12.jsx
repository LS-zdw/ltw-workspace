...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-培训记录管理_1" desc="module=edu/trainer · pageId=ep-12 · path=/edu/trainer/ep-12"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/培训记录管理_1.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：培训记录管理_1</div>
