...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-企业教育培训情况统计" desc="module=edu/trainer · pageId=ep-18 · path=/edu/trainer/ep-18"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/企业教育培训情况统计.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：企业教育培训情况统计</div>
