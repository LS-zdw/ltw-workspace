...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-劳务派遣岗位信息维护" desc="module=edu/trainer · pageId=ep-06 · path=/edu/trainer/ep-06"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/劳务派遣岗位信息维护.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：劳务派遣岗位信息维护</div>
