...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-安全管理人员岗位信息维护" desc="module=edu/trainer · pageId=ep-01 · path=/edu/trainer/ep-01"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/安全管理人员岗位信息维护.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：安全管理人员岗位信息维护</div>
