...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-培训师资管理-企业端" desc="module=edu/trainer · pageId=ep-14 · path=/edu/trainer/ep-14"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/培训师资管理-企业端.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：培训师资管理-企业端</div>
