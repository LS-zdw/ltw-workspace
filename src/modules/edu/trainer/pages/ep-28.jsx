...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-总部教育培训情况统计" desc="module=edu/trainer · pageId=ep-28 · path=/edu/trainer/ep-28"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/总部教育培训情况统计.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：总部教育培训情况统计</div>
