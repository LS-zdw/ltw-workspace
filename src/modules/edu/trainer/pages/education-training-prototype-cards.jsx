...
const normalizeTitle = (title) => {
  ...
  if (title === "教育培训（更新）-教育培训统计分析-总部端") return "教育培训-总部统计分析";
  if (title === "教育培训（更新）-日周月统计分析-总部端") return "教育培训-日周月统计分析";
  return title;
};
...
const featurePoints = {
  ...
  "教育培训-日周月统计分析": [
    { name: "日动态监控", effect: "按日展示培训计划、证书、备案与新增记录等核心指标" },
    { name: "周总结汇报", effect: "按周汇总培训执行进度、取证情况与培训完成信息" },
    { name: "月度分析看板", effect: "按月呈现培训开展、计划执行、取证与综合排名分析" }
  ]
};
