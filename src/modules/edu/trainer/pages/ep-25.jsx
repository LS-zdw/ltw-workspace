...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-证书管理-企业端" desc="module=edu/trainer · pageId=ep-25 · path=/edu/trainer/ep-25"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/证书管理-企业端.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：证书管理-企业端</div>
