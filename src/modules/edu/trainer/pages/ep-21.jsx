...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-新员工与转岗信息维护" desc="module=edu/trainer · pageId=ep-21 · path=/edu/trainer/ep-21"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/新员工与转岗信息维护.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：新员工与转岗信息维护</div>
