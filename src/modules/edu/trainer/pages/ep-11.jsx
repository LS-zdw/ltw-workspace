...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-培训计划审批-企业端" desc="module=edu/trainer · pageId=ep-11 · path=/edu/trainer/ep-11"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/培训计划审批-企业端.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：培训计划审批-企业端</div>
