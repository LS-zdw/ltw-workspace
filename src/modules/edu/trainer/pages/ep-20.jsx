...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-特种设备作业人员岗位信息维护" desc="module=edu/trainer · pageId=ep-20 · path=/edu/trainer/ep-20"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/特种设备作业人员岗位信息维护.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：特种设备作业人员岗位信息维护</div>
