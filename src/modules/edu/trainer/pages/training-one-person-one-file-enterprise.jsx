          ...
          <Card title="人员档案台账" desc="">
            <div className="table-wrap">
              <table className="proto-table">
                <thead>
                  <tr>
                    <th className="table-checkbox"><input type="checkbox" readOnly /></th><th>序号</th><th>组织机构</th><th>用户姓名</th><th>统一账号</th><th>手机号码</th><th>岗位</th><th>人员类型</th><th>性别</th><th>民族</th><th>累计培训学时</th><th>参训项目数</th><th>操作</th>
                  </tr>
                </thead>
                <tbody>
                  
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>1</td><td>安环部</td><td><button type="button" className="table-link-btn" onClick={() => openModal("person-archive-detail", "")}>张明</button></td><td>ZHANGMING320821</td><td>13812345678</td><td>安全管理岗</td><td>新员工</td><td>男</td><td>汉族</td><td>86</td><td>12</td><td><button type="button" className="table-link-btn" onClick={() => openModal("person-archive-detail", "")}>学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>2</td><td>运行三部</td><td><button type="button" className="table-link-btn">刘敏</button></td><td>LIUMIN420602</td><td>13987651234</td><td>运行值班岗</td><td>在岗员工</td><td>女</td><td>汉族</td><td>74</td><td>9</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>3</td><td>安环部</td><td><button type="button" className="table-link-btn">王凯</button></td><td>WANGKAI330115</td><td>13745211234</td><td>工艺技术岗</td><td>在岗员工</td><td>男</td><td>汉族</td><td>92</td><td>14</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>4</td><td>生产技术部</td><td><button type="button" className="table-link-btn">周静</button></td><td>ZHOUJING220907</td><td>13689004567</td><td>设备管理岗</td><td>在岗员工</td><td>女</td><td>汉族</td><td>65</td><td>8</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>5</td><td>安全环保部</td><td><button type="button" className="table-link-btn">沈涛</button></td><td>SHENTAO500721</td><td>13502119876</td><td>安全管理岗</td><td>新员工</td><td>男</td><td>汉族</td><td>51</td><td>6</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>6</td><td>运行二部</td><td><button type="button" className="table-link-btn">许菲</button></td><td>XUFEI440312</td><td>13900234567</td><td>运行值班岗</td><td>在岗员工</td><td>女</td><td>汉族</td><td>79</td><td>11</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>7</td><td>设备工程部</td><td><button type="button" className="table-link-btn">韩博</button></td><td>HANBO371201</td><td>13877665544</td><td>设备管理岗</td><td>转岗员工</td><td>男</td><td>汉族</td><td>58</td><td>7</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>8</td><td>综合管理部</td><td><button type="button" className="table-link-btn">朱琳</button></td><td>ZHULIN460102</td><td>13799112233</td><td>综合管理岗</td><td>在岗员工</td><td>女</td><td>汉族</td><td>73</td><td>10</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>9</td><td>安环部</td><td><button type="button" className="table-link-btn">丁浩</button></td><td>DINGHAO360226</td><td>13633004567</td><td>安全管理岗</td><td>在岗员工</td><td>男</td><td>汉族</td><td>88</td><td>13</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
              <tr>
                <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>10</td><td>运行一部</td><td><button type="button" className="table-link-btn">唐悦</button></td><td>TANGYUE430205</td><td>13756789012</td><td>运行值班岗</td><td>新员工</td><td>女</td><td>汉族</td><td>69</td><td>9</td><td><button type="button" className="table-link-btn">学习详情</button></td>
              </tr>
                </tbody>
              </table>
            </div>
              ...
              <div className="cert-section">
                ...
                <div className="table-wrap">
                  <table className="proto-table">
                    ...
                    <tbody>
                      <tr><td>班组长安全履职能力考核（一期）</td><td>2026-03-07</td><td>89</td><td className="cell-ok">是</td><td>班组长安全提升一期</td></tr><tr><td>新员工三级教育结业测评（2月）</td><td>2026-02-06</td><td>92</td><td className="cell-ok">是</td><td>新员工三级教育（2月）</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
