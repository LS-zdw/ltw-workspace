...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-员工教育培训信息" desc="module=edu/trainer · pageId=ep-23 · path=/edu/trainer/ep-23"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/员工教育培训信息.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：员工教育培训信息</div>
