...
export default function Page() {
  ...
  return (
    <div className="stack">
      <Card title="教育培训-班组安全活动计划" desc="module=edu/trainer · pageId=ep-03 · path=/edu/trainer/ep-03"
      ...
      >
        ...
        <div className="pill mt-10">
          ...
          <div className="v">edu-ep/班组安全活动计划.html</div>
        </div>
      </Card>
      ...
      <div className="pill">
        <div className="k">原型页面：班组安全活动计划</div>
