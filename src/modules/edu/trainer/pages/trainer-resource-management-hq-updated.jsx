...
const titleOptions = ["初级", "中级", "高级"];

const trainerRows = [
  { id: 1, enterprise: "镇海炼化", dataSource: "企业维护", name: "梁海江", gender: "男", org: "安全环保部", position: "安全主管", title: "高级", major: "化工安全", education: "本科", phone: "15001213760", intro: "长期从事安全培训工作" },
  { id: 2, enterprise: "茂名石化", dataSource: "企业维护", name: "方月蒙", gender: "女", org: "教育培训中心", position: "设备专员", title: "中级", major: "电气工程", education: "本科", phone: "15537290777", intro: "具备丰富授课经验" },
  { id: 3, enterprise: "洛阳石化", dataSource: "企业维护", name: "张亮", gender: "男", org: "安环部", position: "运行班长", title: "高级", major: "石油化工", education: "大专", phone: "13681525946", intro: "长期从事现场培训" },
  { id: 4, enterprise: "九江石化", dataSource: "企业维护", name: "尤红玉", gender: "女", org: "设备管理部", position: "仪表工程师", title: "中级", major: "自动化", education: "本科", phone: "18010180072", intro: "擅长实操授课" },
  { id: 5, enterprise: "广州石化", dataSource: "企业维护", name: "卢伟", gender: "男", org: "安环部", position: "培训讲师", title: "中级", major: "炼油工艺", education: "本科", phone: "13811220011", intro: "炼化培训讲师" },
  { id: 6, enterprise: "福建联合", dataSource: "企业维护", name: "杨青", gender: "女", org: "生产技术部", position: "班组骨干", title: "初级", major: "安全工程", education: "本科", phone: "13911330022", intro: "班组培训骨干" },
  { id: 7, enterprise: "仪征化纤", dataSource: "企业维护", name: "李卓", gender: "男", org: "教育培训中心", position: "课程开发", title: "中级", major: "安全管理", education: "硕士", phone: "13711440033", intro: "课程开发" },
  { id: 8, enterprise: "天津石化", dataSource: "企业维护", name: "谢峰", gender: "男", org: "安环部", position: "危化专家", title: "高级", major: "应用化学", education: "本科", phone: "13611550044", intro: "危化专业" },
  { id: 9, enterprise: "海南炼化", dataSource: "企业维护", name: "周凯", gender: "男", org: "生产运行部", position: "现场讲师", title: "高级", major: "油气储运", education: "大专", phone: "13511660055", intro: "现场实操" },
  { id: 10, enterprise: "集团总部", dataSource: "总部自建", name: "陈涛", gender: "男", org: "安全监管部", position: "新任讲师", title: "初级", major: "环境工程", education: "本科", phone: "13411770066", intro: "总部自建共享师资" }
];
            ...
            <div className="cert-form-grid">
              <div className="cert-field-item">
                ...
                <div className="cert-field-value">
                  <select className="cert-field-control" defaultValue={mode === "add" ? "总部自建" : defaultForm.dataSource} disabled={readOnly}>
                    <option>企业维护</option>
                    <option>总部自建</option>
                  </select>
                </div>
              ...
              <div className="cert-field-item">
                <div className="cert-field-label"><span className="required-mark">*</span>所属企业：</div>
                <div className="cert-field-value">
                  <select className="cert-field-control" defaultValue={mode === "add" ? "集团总部" : defaultForm.enterprise} disabled={readOnly}>
                    <option>集团总部</option>
              ...
              <div className="cert-field-item">
                ...
                <div className="cert-field-value">
                  <select className="cert-field-control" defaultValue={mode === "add" ? "请选择" : defaultForm.gender} disabled={readOnly}>
                    <option>请选择</option>
                    <option>男</option>
                    <option>女</option>
                  </select>
              ...
              <div className="cert-field-item">
                ...
                <div className="cert-field-value"><input className="cert-field-control" defaultValue={mode === "add" ? "" : defaultForm.org} placeholder="输入所属单位" disabled={readOnly} /><span style={{ color: "#98a2b3", marginLeft: 8 }}>0/30</span></div>
              </div>
              <div className="cert-field-item">
                <div className="cert-field-label">职位：</div>
                <div className="cert-field-value"><input className="cert-field-control" defaultValue={mode === "add" ? "" : defaultForm.position} placeholder="请输入职位" disabled={readOnly} /></div>
              </div>
              <div className="cert-field-item">
                <div className="cert-field-label"><span className="required-mark">*</span>职称：</div>
                <div className="cert-field-value">
                  <select className="cert-field-control" defaultValue={mode === "add" ? "请选择" : defaultForm.title} disabled={readOnly}>
                    <option>请选择</option>
              ...
              <div className="cert-field-item">
                ...
                <div className="cert-field-value"><input className="cert-field-control" defaultValue={mode === "add" ? "" : defaultForm.major} placeholder="请输入专业" disabled={readOnly} /></div>
              </div>
              <div className="cert-field-item">
                <div className="cert-field-label">学历：</div>
                <div className="cert-field-value">
                  <select className="cert-field-control" defaultValue={mode === "add" ? "请选择" : defaultForm.education} disabled={readOnly}>
                    <option>请选择</option>
                    <option>大专</option>
                    <option>本科</option>
                    <option>硕士</option>
              ...
              <div className="cert-field-item cert-field-item-wide">
                <div className="cert-field-label"><span className="required-mark">*</span>教师简介：</div>
                <div className="cert-field-value"><textarea className="cert-field-control cert-field-textarea" defaultValue={mode === "add" ? "" : defaultForm.intro} placeholder="请输入教师简介" disabled={readOnly} /><span style={{ color: "#98a2b3", marginLeft: 8 }}>0/100</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="filterbar">
        <div className="filterbar-row">
          <div className="filterbar-left">
            ...
            <div className="filterbar-item"><div className="filterbar-label">数据来源：</div><div className="filterbar-input"><select className="filterbar-control" defaultValue="全部"><option>全部</option><option>企业维护</option><option>总部自建</option></select></div></div>
            ...
            <div className="filterbar-item"><div className="filterbar-label">性别：</div><div className="filterbar-input"><select className="filterbar-control" defaultValue="全部"><option>全部</option><option>男</option><option>女</option></select></div></div>
            <div className="filterbar-item">
        ...
        <table className="proto-table">
          <thead>
            <tr>
              ...
              <th>序号</th><th>所属企业</th><th>数据来源</th><th>姓名</th><th>性别</th><th>所属单位</th><th>职位</th><th>职称</th><th>专业</th><th>学历</th><th>联系方式</th><th>教师简介</th><th>操作</th>
            </tr>
          </thead>
          <tbody>
            {trainerRows.map((row) => (
              <tr key={row.id}>
                ...
                <td>{row.gender}</td><td>{row.org}</td><td>{row.position}</td><td>{row.title}</td><td>{row.major}</td><td>{row.education}</td><td>{row.phone}</td><td>{row.intro}</td>
                <td>
