...
export default function Page() {
  ...
  return (
    <div className="stack">
      ...
      <Card title="基础设计阶段台账" desc="">
        <div className="table-wrap">
          <table className="proto-table">
            <thead>
              <tr>
                <th className="table-checkbox"><input type="checkbox" readOnly /></th><th>序号</th><th>所属企业</th><th>项目名称</th><th>项目级别</th><th>项目阶段</th><th>预评价单位</th><th>预评价批复日期</th><th>设计单位</th><th>项目状态</th><th>操作</th>
              </tr>
            </thead>
            <tbody>
              
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>1</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>2</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>3</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>4</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>5</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>6</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>7</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>8</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>9</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>10</td><td>海南炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>17万吨SBC项目</button></td><td>一类项目</td><td>基础设计阶段</td><td>中石化安研院</td><td>2026-01-28</td><td>SEI</td><td>待会签</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=17万吨SBC项目")}>维护</button></td>
          </tr>
            </tbody>
          </table>
        </div>
      ...
      <Card title="说明" desc="基础设计上报与批复字段可由外部系统集成，其余字段可人工维护">
        
        <div className="pill">
          <div className="k">说明</div>
          <div className="v">基础设计上报与批复字段可由外部系统集成，其余字段可人工维护</div>
        </div>
      </Card>
        ...
        <div className="modal-mask" onClick={closeModal}>
          <div className="modal modal-xl" onClick={(e) => e.stopPropagation()}>
            <div className="modal-hd">
              <div>
                <div className="modal-title">一类项目基础设计阶段项目详情</div>
          ...
          <div className="detail-meta-item">
            ...
            <div className="detail-meta-val">{resolveDynamic("2024年2月1日")}</div>
              ...
              <div className="detail-section">
                <div className="detail-section-title">基础设计基本信息</div>
                <div className="detail-form-grid">
                  
              <div className="detail-form-item">
                <div className="detail-form-key">基础设计上报时间</div>
                <div className="detail-form-val">{resolveDynamic("选择时间")}</div>
              </div>
              <div className="detail-form-item">
                <div className="detail-form-key">基础设计上报文号</div>
                <div className="detail-form-val">{resolveDynamic("请输入内容")}</div>
              </div>
              <div className="detail-form-item">
                <div className="detail-form-key">基础设计批复时间</div>
                <div className="detail-form-val">{resolveDynamic("选择时间")}</div>
              </div>
              <div className="detail-form-item">
                <div className="detail-form-key">基础设计批复文号</div>
                <div className="detail-form-val">{resolveDynamic("请输入内容")}</div>
              </div>
                </div>
              ...
              <div className="detail-section">
                <div className="detail-section-title">安全设施设计审查信息</div>
                <div className="detail-form-grid">
              ...
              <div className="detail-form-item">
                <div className="detail-form-key">专家组评审意见及个人意见</div>
                <div className="detail-form-val">{resolveDynamic("点击上传")}</div>
              </div>
              <div className="detail-form-item">
                <div className="detail-form-key">参加人员签名表</div>
                <div className="detail-form-val">{resolveDynamic("点击上传")}</div>
              </div>
              <div className="detail-form-item">
              ...
              <div className="detail-section">
                <div className="detail-section-title">非第七条项目字段</div>
                <div className="detail-form-grid">
              ...
              <div className="detail-form-item">
                <div className="detail-form-key">安全设施设计</div>
                <div className="detail-form-val">{resolveDynamic("点击上传")}</div>
              </div>
              <div className="detail-form-item">
                <div className="detail-form-key">专家意见</div>
                <div className="detail-form-val">{resolveDynamic("点击上传")}</div>
              </div>
                </div>
              ...
              <div className="detail-section">
                <div className="detail-section-title">非政府审核字段</div>
                <div className="detail-form-grid">
        ...
        <div className="modal-mask" onClick={closeModal}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-bd">
              ...
              <div className="pill">
                <div className="k">说明</div>
                <div className="v">确认后将提交基础设计阶段资料。</div>
              </div>
            </div>
            <div className="modal-ft">
              <button type="button" className="btn" onClick={closeModal}>
