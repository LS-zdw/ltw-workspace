    ...
    <div className="stack">
      ...
      <Card title="基础设计阶段台账" desc="">
        <div className="table-wrap">
          ...
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>1</td><td>镇海炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>常减压改造工程</button></td><td>二类项目</td><td>基础设计阶段</td><td>华东安评公司</td><td>2026-01-22</td><td>宁波工程</td><td>已归档</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>查看</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>2</td><td>荆门分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>化工罐区优化项目</button></td><td>三类项目</td><td>基础设计阶段</td><td>华中安评公司</td><td>2026-01-24</td><td>中石化五建</td><td>待补录</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>3</td><td>镇海炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>常减压改造工程</button></td><td>二类项目</td><td>基础设计阶段</td><td>华东安评公司</td><td>2026-01-22</td><td>宁波工程</td><td>已归档</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>查看</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>4</td><td>荆门分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>化工罐区优化项目</button></td><td>三类项目</td><td>基础设计阶段</td><td>华中安评公司</td><td>2026-01-24</td><td>中石化五建</td><td>待补录</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>5</td><td>镇海炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>常减压改造工程</button></td><td>二类项目</td><td>基础设计阶段</td><td>华东安评公司</td><td>2026-01-22</td><td>宁波工程</td><td>已归档</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>查看</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>6</td><td>荆门分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>化工罐区优化项目</button></td><td>三类项目</td><td>基础设计阶段</td><td>华中安评公司</td><td>2026-01-24</td><td>中石化五建</td><td>待补录</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>7</td><td>镇海炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>常减压改造工程</button></td><td>二类项目</td><td>基础设计阶段</td><td>华东安评公司</td><td>2026-01-22</td><td>宁波工程</td><td>已归档</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>查看</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>8</td><td>荆门分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>化工罐区优化项目</button></td><td>三类项目</td><td>基础设计阶段</td><td>华中安评公司</td><td>2026-01-24</td><td>中石化五建</td><td>待补录</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>维护</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>9</td><td>镇海炼化</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>常减压改造工程</button></td><td>二类项目</td><td>基础设计阶段</td><td>华东安评公司</td><td>2026-01-22</td><td>宁波工程</td><td>已归档</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=常减压改造工程")}>查看</button></td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>10</td><td>荆门分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>化工罐区优化项目</button></td><td>三类项目</td><td>基础设计阶段</td><td>华中安评公司</td><td>2026-01-24</td><td>中石化五建</td><td>待补录</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>维护</button></td>
          </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="modal-mask" onClick={closeModal}>
          <div className="modal modal-xl" onClick={(e) => e.stopPropagation()}>
            <div className="modal-hd">
              <div>
                <div className="modal-title">二类、三类项目基础设计阶段项目详情</div>
          ...
          <div className="detail-meta-item">
            ...
            <div className="detail-meta-val">{resolveDynamic("二类、三类项目（企业级）")}</div>
          </div>
          <div className="detail-meta-item">
          ...
          <div className="detail-meta-item">
            ...
            <div className="detail-meta-val">{resolveDynamic("2024年2月1日")}</div>
              ...
              <div className="detail-form-item">
                <div className="detail-form-key">评审会参加人员签到表</div>
                <div className="detail-form-val">{resolveDynamic("点击上传")}</div>
              </div>
              <div className="detail-form-item">
                <div className="detail-form-key">安全设施设计修改说明</div>
                <div className="detail-form-val">{resolveDynamic("点击上传")}</div>
              </div>
                </div>
