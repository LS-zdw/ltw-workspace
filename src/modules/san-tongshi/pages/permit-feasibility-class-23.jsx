    ...
    <div className="stack">
      ...
      <Card title="可研阶段台账" desc="">
        <div className="table-wrap">
          ...
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>1</td><td>茂名分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=乙烯改造项目")}>乙烯改造项目</button></td><td>二类项目</td><td>可研阶段</td><td>华南安评公司</td><td>洛阳工程公司</td><td>已批复</td><td>李四</td><td>2026-01-19</td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>2</td><td>荆门分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=化工罐区优化项目")}>化工罐区优化项目</button></td><td>三类项目</td><td>可研阶段</td><td>华中安评公司</td><td>中石化五建</td><td>待批复</td><td>王五</td><td>2026-01-21</td>
          </tr>
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>3</td><td>茂名分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=乙烯改造项目")}>乙烯改造项目</button></td><td>二类项目</td><td>可研阶段</td><td>华南安评公司</td><td>洛阳工程公司</td><td>已批复</td><td>李四</td><td>2026-01-19</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>5</td><td>茂名分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=乙烯改造项目")}>乙烯改造项目</button></td><td>二类项目</td><td>可研阶段</td><td>华南安评公司</td><td>洛阳工程公司</td><td>已批复</td><td>李四</td><td>2026-01-19</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>7</td><td>茂名分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=乙烯改造项目")}>乙烯改造项目</button></td><td>二类项目</td><td>可研阶段</td><td>华南安评公司</td><td>洛阳工程公司</td><td>已批复</td><td>李四</td><td>2026-01-19</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className="table-checkbox"><input type="checkbox"  readOnly /></td><td>9</td><td>茂名分公司</td><td><button type="button" className="table-link-btn" onClick={() => openModal("project-detail", "/san-tongshi/task-detail?project=乙烯改造项目")}>乙烯改造项目</button></td><td>二类项目</td><td>可研阶段</td><td>华南安评公司</td><td>洛阳工程公司</td><td>已批复</td><td>李四</td><td>2026-01-19</td>
          </tr>
          <tr>
        ...
        <div className="modal-mask" onClick={closeModal}>
          <div className="modal modal-xl" onClick={(e) => e.stopPropagation()}>
            <div className="modal-hd">
              <div>
                <div className="modal-title">二类、三类项目可研阶段项目详情</div>
